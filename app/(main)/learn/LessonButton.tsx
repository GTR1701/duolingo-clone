				...
				{current ? (
					<div className="h-[102px] w-[102px] relative">
						...
						>
                            ...
                            >
                                <Icon className={cn("h-10 w-10", locked ? "fill-neutral-400 text-neutral-400 stroke-neutral-400" : "fill-neutral-100 text-enutral-100", isCompleted && "fill-none stroke-[4]")} />
                            </Button>
                        </CircularProgressbarWithChildren>
					</div>
				) : (
